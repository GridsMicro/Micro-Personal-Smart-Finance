...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#00072D] flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="rounded-2xl border border-[#0F1F55] bg-gradient-to-b from-[#071442] to-[#040E35] p-7 shadow-[0_10px_15px_rgba(0,0,0,0.5)]">
          <div className="space-y-3">
            ...
            <form action={async () => {
              ...
              <button type="submit" className="w-full h-11 rounded-lg border border-[#162660] bg-[#0A1845] text-white text-sm font-medium flex items-center justify-center gap-3 hover:bg-[#0F1F55] transition-all">
