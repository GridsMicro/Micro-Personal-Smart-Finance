...
export default function Navbar({ isDaily = false }: { isDaily?: boolean }) {
  ...
  return (
    <header className="sticky top-0 z-[100] border-b border-white/5 bg-[#121214]/90 backdrop-blur-xl h-20 no-print">
      <div className="max-w-[1600px] mx-auto px-6 h-full flex justify-between items-center gap-8">
         <div className="flex items-center gap-5 group cursor-pointer" onClick={() => router.push("/dashboard")}>
